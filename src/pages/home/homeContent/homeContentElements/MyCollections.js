...
const MyCollection = function () {
  ...
  return (
    <motion.div
      ref={slider}
      className="content__myCollection"
      id="content__myCollection-id"
    >
      <motion.div ref={ref} animate={animation}>
        ...
        <motion.div className="content__myCollection__slider">
          <motion.div
            ...
            className="content__myCollection__slider--wrapper"
          >
            <motion.div className="content__myCollection__slider__slide content__myCollection__slider--text">
              <h3>
                ...
                officia sunt irure. Veniam non excepteur sint sunt id dolor
                pariatur deserunt Lorem fugiat pariatur consectetur nostrud.
                Sunt nostrud culpa elit laborum in pariatur aute pariatur amet
                labore commodo officia.
              </h3>
            </motion.div>
            {images.map((image, index) => {
              return (
                <motion.div
                  key={index}
                  className="content__myCollection__slider__slide"
                >
